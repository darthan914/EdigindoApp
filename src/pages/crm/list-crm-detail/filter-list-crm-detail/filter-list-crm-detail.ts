...
/**
 * Generated class for the FilterListCrmDetailPage page.
 *
 ...
 */
 ...
 @IonicPage()
 @Component({
 	selector: 'page-filter-list-crm-detail',
 	templateUrl: 'filter-list-crm-detail.html',
 })
 export class FilterListCrmDetailPage {
