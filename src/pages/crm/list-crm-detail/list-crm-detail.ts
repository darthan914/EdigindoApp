...
/**
 * Generated class for the ListCrmDetailPage page.
 *
 ...
 */
 ...
 @IonicPage({
 	name: 'list-crm-detail',
 	segment: 'list-crm-detail',
 	defaultHistory: ['home']
 })
 @Component({
 	selector: 'page-list-crm-detail',
 	templateUrl: 'list-crm-detail.html',
 })
 export class ListCrmDetailPage {
 	...
 	filter()
 	{
 		...
 		const modal = this.modalCtrl.create('FilterListCrmDetailPage', passingData);
